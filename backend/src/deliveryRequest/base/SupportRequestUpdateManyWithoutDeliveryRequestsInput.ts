...
@InputType()
class SupportRequestUpdateManyWithoutDeliveryRequestsInput {
...
export { SupportRequestUpdateManyWithoutDeliveryRequestsInput as SupportRequestUpdateManyWithoutDeliveryRequestsInput };
