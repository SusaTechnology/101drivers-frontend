...
@InputType()
class DeliveryAssignmentWhereInput {
  @ApiProperty({
    required: false,
    type: DateTimeFilter,
  })
  ...
  assignedBy?: UserWhereUniqueInput;
  ...
  unassignedAt?: DateTimeNullableFilter;
...
export { DeliveryAssignmentWhereInput as DeliveryAssignmentWhereInput };
