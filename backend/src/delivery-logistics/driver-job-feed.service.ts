...
async getDriverJobFeed(input: {
              ...
              if (exPickupMs < earliestArrivalMs) {
                ...
                stackingDetails = {
                  ...
                  conflictingDelivery: {
                    ...
                    pickupWindowStart: ex.pickupWindowStart ? new Date(ex.pickupWindowStart).toISOString() : null,
  ...
  // Always uses reference dropoff location as origin for drive time.
  // GPS proximity check (1-mile) happens later at pickup time on the checklist page.
