...
> = {
  ...
  "insurance-mileage": [
    { key: "deliveryId", label: "Ride ID", width: 30 },
    { key: "driverId", label: "Driver ID", width: 30 },
    { key: "driverName", label: "Driver Name", width: 28 },
    { key: "status", label: "Status", type: "status", width: 18 },
    { key: "pickupAddress", label: "Pickup Address (Start)", width: 36 },
    { key: "dropoffAddress", label: "Dropoff Address (End)", width: 36 },
    { key: "startedAt", label: "Start Time", type: "datetime", width: 22 },
    { key: "stoppedAt", label: "End Time", type: "datetime", width: 22 },
    { key: "drivenMiles", label: "Miles", type: "miles", width: 14 },
    { key: "drivenHours", label: "Driven Hours", type: "number", width: 14 },
    { key: "paymentAmount", label: "Payment Amount", type: "money", width: 16 },
    { key: "payoutAmount", label: "Driver Payout", type: "money", width: 16 },
    { key: "customerName", label: "Customer", width: 28 },
