...
const CREATE_INPUT = {
  createdAt: new Date(),
  disabledAt: new Date(),
  disabledReason: "exampleDisabledReason",
  email: "exampleEmail",
  ...
  test("POST /users", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        disabledAt: CREATE_RESULT.disabledAt.toISOString(),
      ...
      .expect([
        {
          ...
          disabledAt: FIND_MANY_RESULT[0].disabledAt.toISOString(),
  ...
  test("GET /users/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        disabledAt: FIND_ONE_RESULT.disabledAt.toISOString(),
