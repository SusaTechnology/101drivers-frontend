              ...
              <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-5">
                ...
                <div className="pt-3 border-t border-slate-100 dark:border-slate-800">
                  ...
                  <p className="mt-3 text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
                    Notifications are <span className="font-bold">email-first</span>. SMS is optional and depends on Admin policy.
                  </p>
                </div>
              </form>
            </CustomCard>
            ...
            <CustomCard className="mt-6 p-5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800">
              <div className="flex items-start gap-3">
                ...
                <p className="text-[11px] text-slate-600 dark:text-slate-300 leading-relaxed font-medium">
                  Secure authentication with email verification. Your session is protected with industry-standard security measures.
                </p>
              </div>
            </CustomCard>
