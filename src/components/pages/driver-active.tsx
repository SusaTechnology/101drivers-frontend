...
// Mock delivery data (fallback while loading) – updated to match API shape
const MOCK_DELIVERY = {
  id: 'DLV-20418',
  pickupAddress: '',
  dropoffAddress: '',
...
export default function DriverActiveDeliveryPage() {
  ...
  // Use real data when available, otherwise fallback to mock (only during loading)
  ...
  useEffect(() => {
    ...
    // In production, replace with real geolocation:
