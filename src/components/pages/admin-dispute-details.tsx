...
const MOCK_DISPUTE = {
  ...
  amount: {
    value: 350.0,
    description: "Estimated repair (prototype)",
  },
              ...
              <CardHeader className="border-b border-slate-100 dark:border-slate-800">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <CardDescription className="text-sm mt-1">
                      Delivery proofs supporting investigation (PRD: photos, VIN
            ...
            <Card className="border-slate-200 dark:border-slate-800 shadow-lg overflow-hidden">
              <CardHeader className="border-b border-slate-100 dark:border-slate-800">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <CardDescription className="text-sm mt-1">
                      Authorization/capture and adjustments (PRD).
                    </CardDescription>
                  </div>
                  <Badge
                    variant="outline"
              ...
              <CardContent className="p-6 sm:p-7 space-y-4">
                ...
                <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
                  Prototype: payment events and adjustments will be recorded as
              ...
              <CardContent className="p-6 sm:p-7 space-y-4">
                ...
                <Alert className="bg-amber-50 dark:bg-amber-900/10 border-amber-200 dark:border-amber-900/30">
                  ...
                  <AlertDescription className="text-amber-900/80 dark:text-amber-200/80 text-xs mt-1">
                    ...
                    changed). Notifications should be email-first; SMS optional
                    by policy.
                  </AlertDescription>
                </Alert>
              </CardContent>
              ...
              <CardHeader className="border-b border-slate-100 dark:border-slate-800">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <CardDescription className="text-sm mt-1">
                      Combined dispute + delivery events (prototype view).
                    </CardDescription>
                  </div>
                  <Badge
                    variant="outline"
