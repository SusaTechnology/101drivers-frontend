          ...
          <CardContent className="p-7 sm:p-10">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-2xl bg-lime-500/15 flex items-center justify-center shrink-0">
                <FileText className="h-6 w-6 text-lime-500 font-bold" />
              </div>
              <div>
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 mt-2">
                  This Privacy Policy describes how 101 Drivers collects, uses, and protects your information.
                </p>
                <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-3">
                  Last updated: <span className="font-bold">March 2024</span>
                </p>
              </div>
            </div>
            ...
            <div className="mt-8 space-y-6 text-slate-600 dark:text-slate-300">
              <p className="text-sm leading-relaxed">
                This Privacy Policy describes how 101 Drivers will collect, use, and share information when you use our services.
                The final version will reflect product requirements and applicable laws for California operations.
              </p>
                ...
                <CardContent className="p-5">
                  ...
                  <ul className="mt-3 space-y-2 text-sm list-disc pl-5">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Account & contact information (email-first notifications; phone optional).</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Users className="h-4 w-4 text-slate-400 mt-0.5 shrink-0" />
                      <span>Delivery details you submit (pickup/drop-off, schedule, vehicle details).</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Camera className="h-4 w-4 text-slate-400 mt-0.5 shrink-0" />
                      <span>Compliance evidence for deliveries (VIN last-4 verification, photos, odometer readings, timestamps).</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Lock className="h-4 w-4 text-slate-400 mt-0.5 shrink-0" />
                      <span>Operational logs to improve reliability and security.</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="rounded-2xl border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950">
                <CardContent className="p-5">
                  <h2 className="text-lg font-extrabold text-slate-900 dark:text-white flex items-center gap-2">
                    ...
                    How we use it (high-level)
                  </h2>
                  <ul className="mt-3 space-y-2 text-sm list-disc pl-5">
                    <li>To provide quotes, manage delivery requests, and coordinate drivers.</li>
                    <li>To send updates by email (SMS optional if enabled by Admin policy).</li>
                    <li>To support compliance, auditability, and dispute resolution.</li>
              ...
              <Card className="rounded-2xl border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950">
                <CardContent className="p-5">
                  ...
                  <ul className="mt-3 space-y-2 text-sm list-disc pl-5">
                    <li>With drivers and admins only as needed to complete deliveries.</li>
                    <li>With service providers (e.g., email delivery) to operate the platform.</li>
              ...
              <div className="mt-6 p-4 rounded-2xl bg-amber-50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-900/30 flex gap-3">
                ...
                <p className="text-[11px] text-amber-900 dark:text-amber-200 leading-normal font-medium">
                  For questions about our privacy practices or to request access to your personal information, please contact our support team.
                </p>
              </div>
