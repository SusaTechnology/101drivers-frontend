      ...
      <main className="max-w-[900px] mx-auto px-5 sm:px-6 py-6 pb-28 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
              <div>
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 mt-2">
                  Earnings from completed deliveries. Payout timing depends on Admin payment policy (prototype view).
                </p>
              </div>
        ...
        <Card className="border-slate-200 dark:border-slate-800 shadow-lg">
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <CardDescription className="text-sm mt-1">
                  Add your preferred payout destination (prototype). In production this is verified and stored securely.
                </CardDescription>
              </div>
          ...
          <CardContent className="space-y-5">
            ...
            <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
              Prototype only: do not enter real banking details. Production app will use secure tokenization + verification.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-slate-200 dark:border-slate-800 shadow-lg hover-lift">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
                Notes: pricing rules and payout formulas are controlled by Admin (pricing + payment policy). Final logic is PRD-driven.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card id="payouts" className="border-slate-200 dark:border-slate-800 shadow-lg overflow-hidden">
          <CardHeader className="border-b border-slate-100 dark:border-slate-800">
            ...
            <CardDescription className="text-sm mt-1">
              Recent payouts and status (prototype).
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="p-6 sm:p-7">
            ...
            <p className="mt-5 text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
              Prototype data. In production, payouts are linked to payment events, refunds/chargebacks, and dispute outcomes.
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6 sm:p-7">
            <Alert className="bg-amber-50 dark:bg-amber-900/10 border-amber-200 dark:border-amber-900/30">
              ...
              <AlertDescription className="text-amber-900/80 dark:text-amber-200/80 text-xs mt-1">
                Prototype UI. Final payout timing and holds depend on Admin payment policy, dispute status, and compliance proof completion.
              </AlertDescription>
            </Alert>
