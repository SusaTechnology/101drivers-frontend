          ...
          <CardContent className="p-6 sm:p-7 space-y-5">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">
                  Admin-configured zones based on demand (prototype). Choose one to opt in.
                </p>
              </div>
              <Link
            ...
            <Alert className="bg-amber-50 dark:bg-amber-900/10 border-amber-200 dark:border-amber-900/30">
              ...
              <AlertDescription className="text-amber-900/80 dark:text-amber-200/80 text-xs mt-1">
                In production, zone suggestions are driven by Admin scheduling policy + operating hours and are logged when you opt in/out.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
        ...
        <Card className="border-slate-200 dark:border-slate-800 shadow-lg">
          <CardContent className="p-6 sm:p-7 space-y-5">
            ...
            <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
              Prototype only: no real matching occurs here. In production, the system may prioritize you for nearby jobs during your window and apply bonuses based on Admin pricing/payment policy.
            </p>
          </CardContent>
        </Card>
      </main>
