...
export default function DealerDashboard() {
  ...
  apiEndPoint: `${import.meta.env.VITE_API_URL}/api/customers/${dealerId}/deliveries`, // or your deliveries endpoint
  noFilter: true,
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-8 h-20 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:flex flex-col leading-tight">
            ...
            <span className="text-base font-extrabold text-slate-900 dark:text-white">Delivery Dashboard</span>
          </div>
          ...
          <Card className="border-slate-200 dark:border-slate-800 rounded-3xl">
            <CardContent className="p-5 sm:p-6">
              ...
              <div className="mt-4 text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
                Note: This is a prototype list. In the real app, the list loads fast with filters and shows key fields
                (time window, pickup, drop-off, miles, price/payout, and status) like an "airport departures" board style.
              </div>
            </CardContent>
          </Card>
        </section>
            ...
            <Card key={delivery.id} className="rounded-3xl hover:shadow-xl transition-shadow">
              <CardContent className="p-5">
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <Link
                    // to="/dealer/delivery/$id"
                    params={{ id: delivery.id.toString() }}
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900 text-white dark:bg-white dark:text-slate-950 font-extrabold hover:opacity-90 transition"
                  >
                    View
                    <ArrowRight className="h-4 w-4" />
          ...
          <Card className="bg-white/70 dark:bg-slate-900/40 border-slate-200 dark:border-slate-800 rounded-3xl">
            <CardContent className="p-5 sm:p-6">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white">Email-first updates</h3>
                  <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">
                    Delivery status changes notify relevant parties by email; SMS can be optional when enabled by Admin policy.
                  </p>
                </div>
                <Link
