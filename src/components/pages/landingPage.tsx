...
export default function LandingPage() {
  ...
  const getQuote = useCreate(`${import.meta.env.VITE_API_URL}/api/deliveryRequests/quote-preview`, {
          ...
          <div className="space-y-7">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400 text-lg mt-3">
                Create a dealer account and submit for Admin approval. Business
                details are selected from a directory.
              </p>
            </div>
