...
export function QuoteDetails() {
  ...
  const quoteDetailsSchema = z.object({
    ...
    carModel: z.string().optional(), // Optional
    vehicleTrim: z.string().optional(), // Optional - new field
  ...
  const watchVehicleTrim = watch("vehicleTrim");
  ...
  // Common trim levels
  const trimLevels = [
    "Base", "LX", "EX", "EX-L", "Touring", "Elite", "Sport", "Sport Touring",
    "LE", "XLE", "SE", "XSE", "Limited", "Platinum", "SR5", "TRD Pro", "TRD Off-Road",
    "S", "SEL", "Premium", "Titanium", "GT", "ST", "RS", "LT", "LTZ", "High Country",
    "2.0T", "3.0T", "Hybrid", "PHEV", "AWD", "4WD", "RWD", "Other"
  ];
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-7">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      {/* Model - OPTIONAL (depends on make) */}
                      <div className="flex flex-col gap-2">
                        <Label className="text-xs font-bold text-slate-700 dark:text-slate-300">
                      ...
                      <div className="flex flex-col gap-2">
                        <Label className="text-xs font-bold text-slate-700 dark:text-slate-300">
                          Vehicle Color <span className="text-slate-400">(optional)</span>
                        </Label>
                        <Select
                      ...
                      <div className="flex flex-col gap-2">
                        <Label className="text-xs font-bold text-slate-700 dark:text-slate-300">
                          Trim <span className="text-slate-400">(optional)</span>
                        </Label>
                        <Select
                          key={`vehicletrim-${draftLoaded}`}
                          value={watchVehicleTrim || ""}
                          onValueChange={(value) => setValue("vehicleTrim", value)}
                        >
                          <SelectTrigger className="h-14 rounded-2xl border-slate-200 dark:border-slate-700 dark:bg-slate-800/40 input-focus-ring text-sm">
