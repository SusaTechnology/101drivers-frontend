...
export const RightHemisphereNav = () => {
  ...
  const loginItems = [
    // { label: "Customer", icon: Building, to: "/home#dealers" },
    { label: "Customer", icon: Building, to: "/auth/dealer-signup" },
    // { label: "Driver", icon: Car, to: "/home#jointhewaitlist" },
    { label: "Driver", icon: Car, to: "/driver-onboarding" },
  ];
