...
import { setAccessToken, setUser } from "@/lib/tanstack/dataQuery";
...
export function DealerSignIn({
  ...
  const loginMutation = useDataMutation<LoginResponse, SignInFormData>({
    ...
    onSuccess: (data) => {
      ...
      setTimeout(() => {
        if (userType === "dealer") navigate({ to: "/dealer-dashboard" });
        else if (userType === "driver") navigate({ to: "/driver-dashboard" });
          ...
          <div className="lg:col-span-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h1 className="text-4xl font-black text-slate-900 dark:text-white">
                  {isAdmin ? "Admin Sign In" : isDealer ? "Dealer Sign In" : "Driver Sign In"}
                </h1>
            ...
            <CustomCard className="mt-10 bg-white/70 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 p-6 sm:p-8">
              <h2 className="text-xl font-black text-slate-900 dark:text-white">
                What you can do as an {isAdmin ? "Admin" : isDealer ? "Dealer" : "Driver"}
              </h2>
              ...
              <div className="flex items-start justify-between gap-4">
                <div>
                  <p className="text-[11px] font-black uppercase tracking-widest text-slate-400">
                    {isAdmin ? "ADMIN" : isDealer ? "DLR" : "DRV"}
                  </p>
              ...
              >
                ...
                >
                  {loginMutation.isPending ? (
                    ...
                    <>
                      Sign In {isAdmin ? "as Admin" : isDealer ? "as Dealer" : "as Driver"}
                ...
                <div className="pt-3 border-t border-slate-100 dark:border-slate-800">
                  ...
                  <p className="mt-3 text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
                    ...
                    optional and depends on Admin policy (PRD).
                  </p>
                </div>
              </form>
            </CustomCard>
