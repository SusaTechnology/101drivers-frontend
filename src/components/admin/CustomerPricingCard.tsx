      ...
      <div className="flex items-center gap-3 p-4 rounded-2xl bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-900/30">
        ...
        <div>
          ...
          <div className="text-xs text-amber-700 dark:text-amber-400 mt-0.5">
            ...
            "Edit" to assign a specific config — new personal customers are
            auto-assigned a Flat Pricing config at registration, and admins
            can change that assignment any time.
          </div>
        </div>
      </div>
    );
